...
- [x] 5.1 CI vérifiée — run normal `35444963260` (`4dc964c`) vert sur Linux Node 22/24, macOS et Windows Node 24, et Chromium Linux avec actions sous Node 24 ; artefact `npm-package-tested` téléchargé (SHA-256 `e3202a0db96e06f21a70d2d714e703ed055c41bb11eff64415328bd4b431211c`) ; PR brouillon [#1](https://github.com/OthmaneBlial/Regex-For-Humans/pull/1) volontairement cassée, run `35444252927` échoué dans les quatre jobs `npm run check`, puis fermée sans fusion
